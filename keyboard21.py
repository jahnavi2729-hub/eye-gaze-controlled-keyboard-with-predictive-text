...
class GazeKeyboard(QWidget):
    ...
    def send_emergency_sms(self):
        try:
            # account_sid = 'AC6bca2500a0df7561836d2b339520bdbb'
            # auth_token = 'f4f4983c1d0189fa838728140e93b610'
            # from_number = '+19412079269'
            # to_number = '+919290680720'
            account_sid = 'AC4d8318c1bd09417c0210d2640612a69d'
            auth_token = 'ff69a2ec0be162917bf0d67b7582f7a6'
            from_number = '+13194633758'
            to_number = '+919290680720'
